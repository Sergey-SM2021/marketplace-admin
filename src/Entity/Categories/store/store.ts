import {Category, CreateCategoryCommand, CreateProductCommand} from "types"
import {CategoryResponseDTO} from "types/models/CategoryResponseDTO"
...
export const getParamsByCategory = categoriesDomain.createEffect(api.getParamsByCategory)

export const $params = categoriesDomain.createStore([]).on(getParamsByCategory.doneData, (state, payload) => payload)
